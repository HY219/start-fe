...
function printItem(item) {
  ...
  create_img.setAttribute('src', item.img);
  $wrap.appendChild(create_img);
  var create_text = document.createElement('div');
  create_text.innerHTML = item.title;
  $wrap.appendChild(create_text);
